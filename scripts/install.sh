...
# ─────────────────────────────────────────────
#  InkForge Installer
#  Usage: curl -fsSL https://raw.githubusercontent.com/wenaryHY/inkforge/main/scripts/install.sh | bash
# ─────────────────────────────────────────────

GITHUB_REPO="wenaryHY/inkforge"
INSTALL_DIR="/opt/inkforge"
DATA_DIR="/var/lib/inkforge"
CONF_DIR="/etc/inkforge"
BACKUP_DIR="/var/backups/inkforge"
SERVICE_USER="inkforge"
LISTEN_PORT=2000

# ── Colors ──
RED='\033[0;31m'; GREEN='\033[0;32m'; YELLOW='\033[0;33m'; NC='\033[0m'
info()  { echo -e "${GREEN}[inkforge]${NC} $*"; }
warn()  { echo -e "${YELLOW}[inkforge]${NC} $*"; }
error() { echo -e "${RED}[inkforge]${NC} $*" >&2; exit 1; }
...
ASSET_NAME="inkforge-${VERSION}-linux-${RELEASE_ARCH}.tar.gz"
...
info "Installing InkForge ${VERSION} (${RELEASE_ARCH})..."
...
mkdir -p "$INSTALL_DIR" "$DATA_DIR/uploads" "$DATA_DIR/pages" \
         "$CONF_DIR" "$BACKUP_DIR" \
         "$INSTALL_DIR/themes" "$INSTALL_DIR/src/admin"

# ── 7. Install files ──
# Binary
cp "${TMPDIR}/inkforge" "${INSTALL_DIR}/inkforge"
chmod 755 "${INSTALL_DIR}/inkforge"
...
ENV_FILE="${CONF_DIR}/inkforge.env"
if [ ! -f "$ENV_FILE" ] || ! grep -q "INKFORGE__AUTH__SECRET" "$ENV_FILE" 2>/dev/null; then
    JWT_SECRET=$(head -c 32 /dev/urandom | base64 | tr -d '/+=' | head -c 48)
    cat > "$ENV_FILE" <<EOF
# InkForge secrets — auto-generated by installer
# Regenerate with: head -c 32 /dev/urandom | base64
INKFORGE__AUTH__SECRET=${JWT_SECRET}
EOF
    chmod 600 "$ENV_FILE"
...
cat > /etc/systemd/system/inkforge.service <<EOF
[Unit]
Description=InkForge CMS
...
ExecStart=${INSTALL_DIR}/inkforge
Restart=always
RestartSec=5
...
Environment=INKFORGE__STORAGE__UPLOAD_DIR=${DATA_DIR}/uploads
Environment=INKFORGE__PATHS__ADMIN_DIST_DIR=${INSTALL_DIR}/src/admin/dist
...
# ── 11. Health check ──
info "Waiting for InkForge to start..."
sleep 3
...
if curl -sf "http://127.0.0.1:${LISTEN_PORT}/api/v1/health" >/dev/null 2>&1; then
    ...
    echo ""
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}  ✅ InkForge ${VERSION} installed successfully!${NC}"
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    echo ""
    echo -e "  Manage:"
    echo -e "    systemctl status inkforge    # check status"
    echo -e "    systemctl restart inkforge   # restart"
    echo -e "    journalctl -u inkforge -f    # view logs"
    echo ""
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
else
    warn "InkForge may not be ready yet. Check: systemctl status inkforge && journalctl -u inkforge -e"
fi
